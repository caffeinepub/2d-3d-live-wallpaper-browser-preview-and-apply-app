...
import type { UserRole as _UserRole, WallpaperMeta as _WallpaperMeta, WallpaperType as _WallpaperType } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getWallpaperCatalog(): Promise<Array<WallpaperMeta>> {
        if (this.processError) {
            try {
                const result = await this.actor.getWallpaperCatalog();
...
function from_candid_WallpaperMeta_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _WallpaperMeta): WallpaperMeta {
    return from_candid_record_n7(_uploadFile, _downloadFile, value);
}
function from_candid_WallpaperType_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _WallpaperType): WallpaperType {
...
function from_candid_record_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        wType: from_candid_WallpaperType_n8(_uploadFile, _downloadFile, value.wType)
    };
}
...
function from_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "live" in value ? WallpaperType.live : "twoD" in value ? WallpaperType.twoD : "threeD" in value ? WallpaperType.threeD : value;
}
function from_candid_vec_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_WallpaperMeta>): Array<WallpaperMeta> {
    return value.map((x)=>from_candid_WallpaperMeta_n6(_uploadFile, _downloadFile, x));
}
